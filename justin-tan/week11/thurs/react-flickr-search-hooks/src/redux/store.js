...
function reducer( state=initialState, action ){
  ...
  switch( action.type ){
    ...
    case 'clickCounter/incremented':
      ...
      // NOTE: treat Redux state as immutable! Make copies of the data and add/delete
      // on the copy, instead of changing the original state. i.e., same as React
      // component's state
...
store.subscribe( () => {
  ...
  // save to local storage, send to backend to save to DB
