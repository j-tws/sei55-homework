...
function useFlickrSearchResults(queryText){
  ...
  }, [queryText] ) // note params as second argument - it means do AJAX search whenever the router param changes
...
// this means you have to use the right name when you import:
// import { useFlickrSearchResults} from 'customHooks'
