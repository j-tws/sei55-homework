...
const insertFlights = () => {
  ...
  db.collection('flights').insertMany(
    [
      {
        ...
        reservations: [
          ...
          { row: 2, col: 3, user_id: 10 }, // NOT real user_ids, just placeholders
          { row: 3, col: 3, user_id: 11 }, // NOT real user_ids, just placeholders
...

      {
        ...
        destination: 'MEL',
        departure_date: new Date('2022-11-20T04:20:00Z'),
        airplane: { name: '767', rows: 20, cols: 6},
        reservations: [
          { row: 1, col: 1, user_id: 10 }, // NOT real user_ids, just placeholders
          { row: 2, col: 3, user_id: 10 }, // NOT real user_ids, just placeholders
          { row: 3, col: 3, user_id: 11 }, // NOT real user_ids, just placeholders
    ...
    (err, result) => {
      ...
      console.log(`Success! Added ${result.insertedCount} `);
